...
- **מצב אורח**: צפייה במידע ציבורי בלבד.
- **כניסה כדייר**: מזינים מזהה דירה/שם דייר (ללא סיסמה).
- **כניסה כמנהל**: שם משתמש `admin`, סיסמה `admin`.
- כפתורי כניסה כדייר / כניסה כמנהל / התנתקות מוצגים תמיד בהדר.

במצב מנהל ניתן לנהל דיירים, חיובים והודעות, ולסגור/לפתוח קריאות. במצב דייר ניתן לפתוח קריאות שירות, לצפות בהודעות ולראות רק חיובים המשויכים למזהה שהוזן.
