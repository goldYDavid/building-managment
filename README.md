...
- **מנהל**: שם משתמש `admin`, סיסמה `admin`.
- **דייר**: מעבר דרך הכפתור "מעבר למצב דייר" (ללא סיסמה). הכפתור תמיד גלוי כשלא נמצאים כבר במצב דייר.
- טופס התחברות מנהל מוצג בכל זמן שאינך מחובר כמנהל, כדי לאפשר מעבר מהיר מדייר למנהל.

במצב מנהל ניתן לנהל דיירים, חיובים והודעות, ולסגור/לפתוח קריאות. במצב דייר ניתן לפתוח קריאות שירות ולצפות במדדים.
